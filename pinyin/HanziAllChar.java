 ...
 */
public class HanziAllChar {
    private static final String TAG = "HanziAllChar";
...
//    private static final boolean DEBUG = false;
    ...
    private static HanziAllChar sInstance;
//    private final boolean mHasChinaCollator;
    ...
    public HanziAllChar(/*boolean hasChinaCollator*/) {
       // mHasChinaCollator = hasChinaCollator;
    }

    public static HanziAllChar getInstance() {
        synchronized (HanziAllChar.class) {
            if (sInstance != null) {
                return sInstance;
            }
          /*  // Check if zh_CN collation data is available
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new HanziAllChar(true);
                    return sInstance;
                }
            }
            Log.w(TAG, "There is no Chinese collator, HanziAllChar is disabled");*/
            sInstance = new HanziAllChar(/*false*/);
            return sInstance;
        }
    }
